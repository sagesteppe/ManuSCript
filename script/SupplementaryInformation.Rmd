...
# Table S1
```{r}
knitr::kable(df, caption = info, col.names = c('Variable', 'Data Source', 'Geographic Extent'), booktabs = TRUE) |> 
...
# Table S2 - Models used for Species Distribution Model Ensembles
...
Table S3 - Species Distribution Models Predictors
