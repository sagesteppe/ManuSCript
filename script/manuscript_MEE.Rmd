...
# ct[["p.value"]] too small to write out. . tau > 0.4 strong
...
To detect whether the sequencing reads were semi-quantitative the subset of all pollen `r ` morphotypes distinguishable by microscopy were regressed against the sequence reads. In all instances sequence reads were pooled to the highest taxonomic rank associated with the morphotype, e.g. if both species of *Mertensia*, or one species and read only classified to genus were present in a sample, the reads were summed. 

The relationship shows that grains which are often present in trace amounts have relatively high amounts of their abundances estimated, and grains which are present in high amounts have relatively low amounts of sequences classified. This is likely due to the proportion of high false positives which occur in the classification process with NGS (BELL NOVEMEBER 2021). The correlation between 
