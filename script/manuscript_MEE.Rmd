...
An enormous amount of Earths biodiversity may be attributed to the interactions between species (@soltis2019darwin, @futuyma2009macroevolution, @voje2015role, @weber2017evolution, @hembry2020ecological). These interactions not only leading to the the origin of many species but are essential to the maintenance of virtually all ecosystems (CITE). In order to understand and rationally conserve both the species and the ecosystems which their interactions compose - Darwins 'Entangled Bank' integrative approaches, with the potential for scaling are required immediately (@darwin2004origin, @thompson1994coevolutionary, @banerjee2022environmental). Major limitations, imposed by a lack of taxonomic expertise, impede our initial ability to identify organisms let alone more complex phenomena (@hebert2003biological). The lack of an ability to identify whole organisms, especially those from diverse clades where species are oftentimes delineated along ecological lines - or on occasion cryptic, lessens the utility of them to serve as bioindicators; a role they are generally pre-disposed to (@Gage2013HistoricalRO, @banerjee2022environmental, @janzen2017nuclear, @oliver2009cryptic). The ability to identify fragments of organisms (e.g. leaf tissue) increases our ability to understand the interactions of a focal, generally rare and hence difficult to detect, organism with their surrounding; allowing for the most precise allocation of conservation decisions and funds e.g. those for restoration processes (@banerjee2022environmental, @johnson2023environmental). 
