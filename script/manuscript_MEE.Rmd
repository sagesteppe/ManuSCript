...
- Timing in other areas may suffer complications due to lacking as strong a signal as that induced by snowmelt, but longer durations of flowering likely to help. 
...
**Final P**
 < bayesian framework > & < harvesting loci >  = Possible Application at landscape scale. 
...
```{r Morphotype Richness, echo= F,  out.width = '99%'}
...
Appendix XX - Molecular Reference Specimen Table (con't)
...
Appendix XX - All Pollen Reference Slides Used to Establish Morphotypes (con't)
