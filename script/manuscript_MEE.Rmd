...
rm(corb, week_tab, flr_date_ranges, pollen_sample_info, blst)
...
blst_reclass_expert <- blst_expert %>% 
  ...
  mutate(TAXON_EXPERT = case_when(
    ...
    sample.id == 36 & Genus == 'Cynoglossum' ~ 'Mertensia.fusiformis',  # 7.99
  ...
  mutate(
    ...
    TAXON_EXPERT = str_replace(TAXON_EXPERT, 'Arenaria globiflora', 'Eremogone congesta'),
