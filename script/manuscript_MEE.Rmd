...
rm( krak, brack, blast, loci, no_loci, aa, bb, cc, dd, fa_total_seqs, 
    ge_total_seqs, sp_total_seqs, seqs_sp, seqs_ge, seqs_fa)
```
...
... many of our results indicate foraging on *Viola* L. spp, zygomorphic flowers with architecture which would require subtle handling and strength to reach the pollen and nectar loads... .. Or the *Epilobium* L. spp. results likely indicating that a species of *Chamerion* Seg. such as *C. angustifolium* (L.) Scop.  or *latifolium* (L.) Sweet is occasionally utilized, as it supported by limited palynology data.  
