...
author:  |
    ...
    |  Reed Clark Benkendorf^[Correspondence: reedbenkendorf2021@u.northwestern.edu] $^1$$^,$$^2$, Jane E. Ogilvie $^3$, Emily J. Woodworth $^1$$^,$$^2$  
abstract:  |  
...
*Complications* We likely had issues detecting pollen from several genera of plants, bsaed upon these and other obesrvationla studies most likely Vicia-Lathyrus and Frasera (CITE), probably due to low quality sequencing of whole plant material... (REED SHOULD HUNT FOR LOCI RETURNS FROM BLAST LIKE HE DID POLLEN)
