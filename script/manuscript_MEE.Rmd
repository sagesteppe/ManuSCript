...
author:  |
    | Reed Clark Benkendorf$^1$$^,$$^2$^[Correspondence: reedbenkendorf2021@u.northwestern.edu], Paul J. CaraDonna$^1$$^,$$^2$$^,$$^3$, Jeremie B. Fant$^1$$^,$$^2$, Jane E. Ogilive$^3$, 
    |  Sophie Taddeo$^1$$^,$$^2$$^,$$^4$, Emily J. Woodworth$^1$$^,$$^2$
    ...
    |  $^4$ The University of California at San Diego, 9500 Gilman Dr, La Jolla, California 92093, USA
abstract:  |  
...
library(knitr)
library(kableExtra)
# devtools::install_github("kupietz/kableExtra") you may need this patch if error persists on render may. 27. 2023
...
### Bee-Flower Observations and Pollen Load Collection
...
```{r Most used resources by species, out.width = "45%"}
...
```{r Most used resources by species figure, fig.cap = 'Number of the ten most commonly visited plants which are also in the top ten most common sequences', out.width = "45%"}
