...
We have demonstrated how a533 data may be used for plant barcoding in a metagenomic context. This was exemplified in an ecologically realistic situation, centered both in a context which serves as an immediate framework for land management studies,  and which produced fundamental natural history information. These datasets included taxonomically difficult clades (e.g. Mertensia, Lupinus) . 
