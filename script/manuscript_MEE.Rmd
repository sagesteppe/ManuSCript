--- 
title: Plant Metagenomic Barcoding using Angiosperms353 of Corbiculae from Queen Bumble Bees
author:  |
...
abstract:  |  
  1) DNA Barcoding has been successful for the rapid analysis of complex ecological assemblages. Barcoding in the plant kingdom barcoding has been more difficult than in others, and hence may begin to lag behind other kingdoms. 
  2) Here we test the utilization of Angiosperms 353 probes to barcode plant species found in corbiculae pollen loads collected from Queen Bumble Bees. 
  3) To verify the accuracy of this barcoding system we compared the barcoding data to museum plant specimens, observations of plant flowering and bee flower visitation in the field, and species distribution modelling to identify likely candidate plant species found within the corbiculae pollen loads.
  ...
  5) We show that the Angiosperms 353 probes, developed for phylogenmoics, and which are currently being used in the largest ever plant systematic endeavor, offer significant promise to metagenomic approaches. 
