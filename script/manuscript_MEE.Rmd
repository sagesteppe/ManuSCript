...
- \usepackage{lineno}
- \linenumbers # cannot co-exist with two columns. 
#classoption: 
#- twocolumn #this makes everything take up two columns, cannot exist with line numbers
---
...
The first date of modelled snow melt in the Gothic area (n = 17, $\bar{x}$ = 137.9, median = 135, 3rd quantile = 151), and the first date of a consistent winter snow base (n = 17, $\bar{x}$ = 299.9, median = 300, 1st quantile = 291) from 2000-2017, were used as delimiters for the inclusions of herbarium records in modelling. Of the 500 species predicted likely present in the area via logistic regression, 332 species (64.4%) with more than 10 records in the focal level 4 ecoregions ($\bar{x}$ = 35.01657, median = 35, max = 96) had weibull estimates calculated, an additional 56 species (11.2%) with enough contributing records from the 'Sedimentary Mid-Elevation Forests', a large ecoregion in general just beneath the elevation bands occupied by the five ecoregions around the study area had weibull estimates also calculated ($\bar{x}$ = 13.86885, median = 13, max = 24).

Only 58 of these 388 species (n = 34.56897, median n = 31) were able to be compared to ground truth data from long term (1970 ? - 2016 ?) datasets.
