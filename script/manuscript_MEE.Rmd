...
blst_final <- blst %>% 
  mutate(TAXON_EXPERTS = case_when(
      ...
      TAXON_NEW %in% c('Caltha leptosepala', 'Trollius europaeus', 'Trollius') ~ 'Delphinium',
    # 'Thalictrum thalictroides' ~ 'Delphinium',
      ...
      TAXON_NEW == 'Erigeron grandiflorus' ~ 'Erigeron grandiflorus',
      TAXON_NEW == 'Epilobium canum' ~ 'Chamaenerion angustifolia',
      TAXON_NEW == 'Paxistima myrsinites' ~ 'Parnassia palustris', # original was probably right !!! shows the consequence of bad time estimates.#, 
