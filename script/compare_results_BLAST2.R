...
write.csv(ACC_sens_Spec, '../data/AccuracyOfPostClassification.csv', row.names = F)
...
# the populations. The p-value is very small so it was either scientific notation or using this rather than 'p value is just a number and significane an arbitraty threshold' vibe.
